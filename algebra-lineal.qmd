...
Una **matriz** $A \in \mathbb{R}^{m \times n}$ es un arreglo rectangular de números reales (o complejos).  
- **Filas**: índice $i=1,\dots,m$.  
- **Columnas**: índice $j=1,\dots,n$.  
- **Entrada**: $a_{ij}$ en la fila $i$, columna $j$.  
- **Matriz identidad** $I_n$: diagonal de unos, resto ceros.  
- **Matriz traspuesta**: $(A^\top)_{ij}=a_{ji}$.
